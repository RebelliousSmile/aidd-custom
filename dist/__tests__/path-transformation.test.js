...
import { transformPath, getToolCustomDir, PATH_TRANSFORMATIONS, } from '../src/index.js';
describe('Path Transformation', () => {
    ...
    describe('PATH_TRANSFORMATIONS', () => {
        it('should have transformers for all tool types', () => {
            const tools = ['claude', 'copilot', 'cursor', 'opencode'];
            tools.forEach((tool) => {
...
//# sourceMappingURL=path-transformation.test.js.map