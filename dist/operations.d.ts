...
export declare function installToolOverlay(tool: ToolType, projectRoot: string, overlayTempDir: string): string[];
export declare function installTemplates(projectRoot: string, overlayTempDir: string): string[];
export declare function installGlobalOverlay(globalRoot: string, overlayTempDir: string): string[];
